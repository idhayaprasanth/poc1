...
def create_layout(df_base, analysis_status_initial=None):
    ...
    return html.Div(
        ...
        children=[
            ...
            dcc.Interval(id="analysis-poll-interval", interval=400, n_intervals=0),
            html.Header(
                style={
                        ...
                        children=[
                            ...
                            html.Div(
                                [
                                    ...
                                    html.P(
                                        "AI-driven threat analysis and prioritization across Tenable and Splunk",
                                        style={
                                            "fontSize": "15px",
            ...
            html.Main(
                ...
                children=[
                    ...
                    dcc.Download(id="download-raw-tenable"),
                    dcc.Download(id="download-raw-splunk"),
